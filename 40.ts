...
function make_album(artistName: string, albumTitle: string, ...tracks: []) {
    return {
        artist: artistName,
        title: albumTitle,
        tracks
...
console.log(make_album("Atif", "Zindagi"))
console.log(make_album("Zia", "Kahani"))
console.log(make_album("Khan", "Dil"))
console.log(make_album("Khan", "Dil",))
